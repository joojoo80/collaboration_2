...
CREATE TABLE seoul_fuel_registration (
    연도 INT NOT NULL, 
    시도 CHAR(6) NOT NULL,          
    전기_승용 INT NOT NULL,        
    하이브리드_승용  INT NOT NULL,                       
    수소_승용  INT NOT NULL            
);


CREATE TABLE seoul_size_registration(
    연도 INT NOT NULL, 
    시도 CHAR(6) NOT NULL,          
    규모 CHAR(10) NOT NULL,      
    승용  INT NOT NULL                      
...
CREATE TABLE seoul_chargers(
    year INT NOT NULL, 
    누적_충전기 INT NOT NULL                  
);


DROP Table seoul_chargers;

INSERT INTO seoul_chargers (year,누적_충전기) VALUES
('2022', 34091),
('2023', 48559),
('2024', 60201)
AS new_data(year,누적_충전기)
ON DUPLICATE KEY UPDATE
    year = new_data.year,
    누적_충전기 = new_data.누적_충전기
;
...
CREATE TABLE IF NOT EXISTS seoul_fuel_registration2024 (
    연도 INT NOT NULL,
...
INSERT INTO seoul_fuel_registration2024 (연도, 시도, 전기_승용, 하이브리드_승용, 수소_승용) VALUES
(2022, '서울', 48914, 166881, 2896),
(2023, '서울', 60154, 205886, 3113),
(2024, '서울', 70021, 256227, 3158);

CREATE TABLE IF NOT EXISTS seoul_size_registration2 (
    연도 INT NOT NULL,
    시도 VARCHAR(20) NOT NULL,
    규모 VARCHAR(10) NOT NULL,
    승용 INT NOT NULL,
    PRIMARY KEY (연도, 시도, 규모)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 데이터 삽입/업데이트
INSERT INTO seoul_size_registration2 (연도, 시도, 규모, 승용) VALUES
(2022, '서울', '소형', 42837),
(2022, '서울', '중형', 1594272),
(2022, '서울', '대형', 942359),
(2022, '서울', '경형', 182233),
...
일반 INT NOT NULL,
친환경 INT NOT NULL,
PRIMARY KEY (연도, 구분, 순위)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO car_sales (연도, 구분, 순위, 브랜드, 전체, 일반, 친환경) VALUES
(2025, '국산', 1, '현대', 577577, 357956, 219621),
(2025, '국산', 2, '기아', 564541, 338893, 225648),
(2025, '국산', 3, '제네시스', 118398, 115415, 2983),
(2025, '수입', 1, 'BMW', 70541, 60219, 10322),
(2025, '수입', 2, '벤츠', 60260, 57024, 3236),
(2025, '수입', 3, '테슬라', 55594, 0, 55594)
ON DUPLICATE KEY UPDATE
브랜드 = VALUES(브랜드),
전체 = VALUES(전체),
일반 = VALUES(일반),
